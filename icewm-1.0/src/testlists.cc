...
int main() {
    puts("Testing single linked lists"); {
        YSingleList<Data> list;
        Data v1(7), v2(13), v3(23), v4(42), v5(66);
        ...
        printf(" - content of the list:\n   - ");
            for (YSingleList<Data>::Iterator i(list.head()); i; ++i)
                printf("%p->{%d}%s", &**i, (*i)->value(), i->next() ? ", " : "");
            newline();

        printf(" - content of the list with counting:\n   - ");
            for (YSingleList<Data>::CountingIterator i(list.head()); i; ++i)
    ...
    puts("Testing double linked lists"); {
        ...
        printf(" - content of the list:\n   - ");
        for (YDoubleList<Data>::Iterator i(list.head()); i; ++i)
            printf("%p->{%d}%s", &**i, (*i)->value(), i->next() ? ", " : "");
        newline();

        printf(" - content of the list with counting:\n   - ");
        for (YDoubleList<Data>::CountingIterator i(list.head()); i; ++i)
            printf("%p->{%d,%d}%s", &**i, i.count(), (*i)->value(),
                                    i->next() ? ", " : "");
        newline();
    ...
    puts("Testing iterators"); {
        ...
        puts(" - testing forward iterator");
            YDoubleList<Data>::ForwardIterator i1(list);
        ...
        puts(" - testing backward iterator");
            YDoubleList<Data>::BackwardIterator i2(list);
        ...
        puts(" - testing counting forward iterator");
            YDoubleList<Data>::CountingIterator i3(list);
        ...
        puts(" - testing counting backward iterator");
            YDoubleList<Data>::CountingBackwardIterator i4(list);
        ...
        puts(" - testing forward ring iterator, starting at head");
            YDoubleList<Data>::ForwardRingIterator i5(list);
        ...
        puts(" - testing forward ring iterator, starting at 3rd element");
            YDoubleList<Data>::ForwardRingIterator i6(list, &v3);
        ...
        puts(" - testing forward ring iterator, starting at last element");
            YDoubleList<Data>::ForwardRingIterator i7(list, list.tail());
        ...
        puts(" - testing backward ring iterator, starting at last element");
            YDoubleList<Data>::BackwardRingIterator i8(list);
        ...
        puts(" - testing backward ring iterator, starting at 3rd element");
            YDoubleList<Data>::BackwardRingIterator i9(list, &v3);
        ...
        puts(" - testing backward ring iterator, starting at head");
            YDoubleList<Data>::BackwardRingIterator i10(list, list.head());
        ...
        dump(YDoubleList<Data>::ForwardRingIterator(list, &v3));
        dump(YDoubleList<Data>::BackwardRingIterator(list, &v3));
